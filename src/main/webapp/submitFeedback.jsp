...
<head>
    ...
    <style>
        ...
        /* Fix hover effect to color only stars up to hovered star */
        .stars span:hover,
        .stars span:hover ~ span {
            color: #ccc;
        }
        ...
        window.onload = function() {
            ...
            stars.forEach((star, index) => {
                star.addEventListener('click', () => {
                    ratingInput.value = index + 1; // set hidden input value
                    stars.forEach((s, i) => {
                        s.classList.toggle('selected', i <= index);
                    });
                });

                // Optional: highlight stars on hover for better UX
